        ...
        {features.map((feature, index) => (
          ...
          >
            <div className="flex items-start gap-4">
              <div className="bg-ghibli-forest/20 rounded-full p-3">
                {feature.icon}
              </div>
              
              <div>
                <h3 className="text-xl font-handwritten text-ghibli-cloud mb-2">
                  {feature.title}
                </h3>
